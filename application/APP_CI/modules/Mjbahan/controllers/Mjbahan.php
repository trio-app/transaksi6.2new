...
class Mjbahan extends MX_Controller {
    ...
    public function create(){   
        ...
        $hasil = $this->C_mjbahan->insertDT(json_decode($jsonData,true));
        print($hasil); 
    }
    public function update(){
        $jsonData =  file_get_contents("php://input");        
        $this->load->model('U_mjbahan');
        $hasil = $this->U_mjbahan->updateDT(json_decode($jsonData,true));
        print($hasil);
    }
    public function delete(){
        $jsonData =  file_get_contents("php://input");        
        $this->load->model('D_mjbahan');
        $hasil = $this->D_mjbahan->deleteDT(json_decode($jsonData,true));
        print($hasil);
    }
